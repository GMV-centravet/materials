...
```mermaid
graph TD;
  materials-datatable-header-column --> materials-icon
  materials-dropdown --> materials-icon
  materials-expansion-panel --> materials-icon
  materials-fab --> materials-icon
  materials-step --> materials-icon
  style materials-icon fill:#f9f,stroke:#333,stroke-width:4px
```
