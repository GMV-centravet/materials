...
```mermaid
graph TD;
  materials-datatable-body-row --> materials-icon-button
  materials-datatable-pagination --> materials-icon-button
  materials-datepicker --> materials-icon-button
  materials-dialog --> materials-icon-button
  materials-dropdown --> materials-icon-button
  style materials-icon-button fill:#f9f,stroke:#333,stroke-width:4px
```
